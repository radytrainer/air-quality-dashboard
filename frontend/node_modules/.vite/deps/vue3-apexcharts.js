...
var $i = function() {
  ...
  return s(t2, [{ key: "isMultiFormat", value: function() {
    ...
    var r2 = t3.map(function(t4, i3) {
      ...
      var n2 = { x: (null === (a3 = t4.parsing) || void 0 === a3 ? void 0 : a3.x) || (null == s2 ? void 0 : s2.x), y: (null === (r3 = t4.parsing) || void 0 === r3 ? void 0 : r3.y) || (null == s2 ? void 0 : s2.y) };
      if (!n2.x && !n2.y) return t4;
      var o2 = t4.data[0];
      if ("object" === b(o2) && null !== o2 && (o2.hasOwnProperty("x") || o2.hasOwnProperty("y")) || Array.isArray(o2)) return t4;
      if (!n2.x || !n2.y) return console.warn("ApexCharts: Series ".concat(i3, " has parsing config but missing x or y field specification")), t4;
      var l2 = t4.data.map(function(t5, a4) {
        ...
        var s3 = e2.getNestedValue(t5, n2.x), r4 = e2.getNestedValue(t5, n2.y);
        return void 0 === s3 && console.warn("ApexCharts: Series ".concat(i3, ", data point ").concat(a4, " missing field '").concat(n2.x, "'")), void 0 === r4 && console.warn("ApexCharts: Series ".concat(i3, ", data point ").concat(a4, " missing field '").concat(n2.y, "'")), { x: s3, y: r4 };
      });
      return u(u({}, t4), {}, { data: l2, __apexParsed: true });
    });
    ...
    if (t3 = this.parseRawDataIfNeeded(t3), i2.series = t3, this.excludeCollapsedSeriesInYAxis(), this.fallbackToCategory = false, this.ctx.core.resetGlobals(), this.ctx.core.isMultipleY(), a2.axisCharts ? (this.parseDataAxisCharts(t3), this.coreUtils.getLargestSeries()) : this.parseDataNonAxisCharts(t3), i2.chart.stacked) {
