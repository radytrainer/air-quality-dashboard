  ...
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-6">
    <div class="max-w-7xl mx-auto space-y-8">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-slate-600 text-base">Real-time global air pollution tracking</p>
      </div>
          ...
          <div class="flex items-center justify-between">
            <div>
              <div class="flex items-center space-x-2 mb-2">
                ...
                <p class="text-sm font-semibold text-slate-600 uppercase tracking-wide">Total Locations</p>
              </div>
          ...
          <div class="flex items-center justify-between">
            <div>
              <div class="flex items-center space-x-2 mb-2">
                ...
                <p class="text-sm font-semibold text-slate-600 uppercase tracking-wide">Highest Pollution</p>
              </div>
          ...
          <div class="flex items-center justify-between">
            <div>
              <div class="flex items-center space-x-2 mb-2">
                ...
                <p class="text-sm font-semibold text-slate-600 uppercase tracking-wide">Lowest Pollution</p>
              </div>
          ...
          <div class="flex items-center justify-between">
            <div>
              <div class="flex items-center space-x-2 mb-2">
                ...
                <p class="text-sm font-semibold text-slate-600 uppercase tracking-wide">Average AQI</p>
              </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-8">
          <div class="flex items-center justify-between mb-6">
            <div>
              <h3 class="text-2xl font-bold text-slate-900 mb-2">Pollution Trends</h3>
              <p class="text-slate-600 text-base">Top 10 vs Bottom 10 locations</p>
            </div>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-5">
          <div class="flex items-center justify-between mb-4">
            <div>
              <h3 class="text-xl font-bold text-slate-900 mb-2">Top Pollution</h3>
              <p class="text-slate-600 text-sm">Updates every 30s</p>
            </div>
            <div class="flex space-x-3">
              ...
              <select v-model="pollutionType" @change="updatePollutionList" class="bg-white/80 border border-slate-200 rounded-lg px-3 py-2 text-sm font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6">
          <div class="flex items-center justify-between mb-6">
            <h3 class="text-xl font-bold text-slate-900">AQI Distribution</h3>
            <div class="w-3 h-3 bg-emerald-500 rounded-full animate-pulse"></div>
          </div>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6">
          <div class="flex items-center justify-between mb-6">
            <h3 class="text-xl font-bold text-slate-900">Environmental Metrics</h3>
            <div class="w-3 h-3 bg-blue-500 rounded-full animate-pulse"></div>
          </div>
          <div class="grid grid-cols-1 gap-4">
            <div class="flex items-center justify-between p-3 bg-gradient-to-br from-white/80 to-slate-50 rounded-lg border border-slate-100 hover:shadow-md transition-all duration-200">
              <div class="flex items-center space-x-3">
            ...
            <div class="flex items-center justify-between p-3 bg-gradient-to-br from-white/80 to-slate-50 rounded-lg border border-slate-100 hover:shadow-md transition-all duration-200">
              <div class="flex items-center space-x-3">
                <div class="w-4 h-4 bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-full"></div>
            ...
            <div class="flex items-center justify-between p-3 bg-gradient-to-br from-white/80 to-slate-50 rounded-lg border border-slate-100 hover:shadow-md transition-all duration-200">
              <div class="flex items-center space-x-3">
                <div class="w-4 h-4 bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-full"></div>
                <span class="text-sm font-medium text-slate-700">Pressure</span>
              </div>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 p-6">
          <div class="flex items-center justify-between mb-6">
            <h3 class="text-xl font-bold text-slate-900">Average Pollution Levels</h3>
            <div class="w-3 h-3 bg-indigo-500 rounded-full animate-pulse"></div>
          </div>
