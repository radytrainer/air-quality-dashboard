    ...
    <div class="flex-1 flex items-center justify-center px-8 relative z-10">
      <div class="w-full max-w-md">
        ...
        <div class="flex mb-8 border-b border-white/20">
          <button class="px-6 py-2 text-white border-b-2 border-white font-medium">Login</button>
          <button @click="$router.push('/register')" class="px-6 py-2 text-gray-300 hover:text-white">Sign Up</button>
        </div>
        ...
        <form @submit.prevent="login" class="space-y-6">
          ...
          <div class="flex items-center justify-between mt-8">
            <label class="flex items-center">
              <input type="checkbox" class="w-4 h-4 text-white bg-transparent border border-white/30 rounded focus:ring-white focus:ring-1 accent-white">
              <span class="ml-3 text-gray-300 text-sm">Remember me</span>
            </label>
            <a href="#" class="text-gray-300 text-sm hover:text-white transition-colors">Forgot your password?</a>
          </div>
        ...
        <p class="text-center text-gray-300 mt-8">
          ...
          <button @click="$router.push('/register')" class="text-white hover:underline font-medium ml-1">Register here</button>
        </p>
